...
//        public static final String KEY = "AIzaSyBH2tUqzab_H9vaCQiABPenrtAs3XeMEOA";

        public static final String KEY = "AIzaSyDgoy8ttzp2VbPbMvXXEuT8cA94ZT0p4sk";


        //Package name of the app that will call the YouTube Data API
        public static final String PACKAGENAME = "edu.ucsb.cs.cs184.wetube";

        //SHA1 fingerprint of APP can be found by double clicking on the app signing report on right tab called gradle
        public static final String SHA1 = "A0:35:6B:DB:CA:80:FB:3D:C8:8B:6D:1B:06:96:9F:48:BC:CC:A8:D9";
        ...
        public YoutubeConnector(Context context) {
            ...
            }).setApplicationName("WeTube").build();
